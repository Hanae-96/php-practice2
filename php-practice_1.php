...
// Q7 連想配列-1
$kanto_region = ['東京都' => '新宿区', '神奈川県' => '横浜市', '千葉県' => '千葉市', '埼玉県' => 'さいたま市', '栃木県' => '宇都宮市', '群馬県' => '前橋市', '茨城県' => '水戸市'];
foreach ($kanto_region as $prefecture => $city) {
    echo $city . "\n";
}
...
// Q11 関数-2
function calcTaxInPrice($no_tax_price) {
    return $no_tax_price * 1.1;
}
